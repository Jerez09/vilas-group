...
<head>
    ...
    <title>{{ __('Crear Propiedad') }}</title>
</head>
...
<body>
    <main class="w-8/12 mx-auto py-10">
        ...
        <form class="w-full" method="post"
            action="{{ route('properties', ['locale' => App::currentLocale()]) }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                    ...
                    <div class="w-4/12 self-end">
                        <div class="relative">
                            <select
                                ...
                                <option value="EUA">{{ __('EUA') }}</option>
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative">
                        <select
                            ...
                            <option value="3">Venta y arriendo</option>
                        </select>
                        <div
                            class="
                                    pointer-events-none
                    ...
                    <div class="relative">
                        <select
                            class="
                                    ...
                                    focus:bg-white
                                    focus:border-gray-500
                                    @error('property_type_id') border-red-500 @enderror
                                "
                            value="{{ old('property_type_id') }}" id="grid-state" name="property_type_id" required>
                            <option selected disabled hidden></option>
                    ...
                    <div class="relative">
                        <select
                            class="
                                ...
                                "
                            value="{{ old('country_id') }}" id="grid-state" name="country_id" required>
                            <option selected disabled hidden></option>
                ...
                <div class="w-full md:w-1/4 px-3">
                    ...
                    <input
                        class="
                            ...
                            "
                        value="{{ old('area') }}" id="area" type="number" name="area" min="0" step="1" required />
                    @error('area')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="w-full md:w-1/4 px-3">
                    ...
                    <input
                        class="
                            ...
                            "
                        value="{{ old('bedrooms') }}" id="bedrooms" type="number" name="bedrooms" min="0" step="1"
                        required />
                    @error('bedrooms')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                ...
                <div class="w-full md:w-1/4 px-3">
                    ...
                    <input
                        class="
                            ...
                            "
                        value="{{ old('bathrooms') }}" id="bathrooms" type="number" name="bathrooms" min="0"
                        step="1" required />
                    @error('bathrooms')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                ...
                <div class="w-full md:w-1/4 px-3">
                    ...
                    <input
                        class="
                            ...
                            "
                        value="{{ old('parking_lots') }}" id="parking" type="number" name="parking_lots" min="0"
                        step="1" required />
                    @error('parking_lots')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
            ...
            <div class="flex flex-wrap -mx-3 mb-9">
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input
                        ...
                        name="thumbnail" required accept="images/*" />
                    @error('thumbnail')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input
                        ...
                        multiple="true" required accept="images/*" />
                    @error('images')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
